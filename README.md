...
- 30 fictional travel websites with bespoke layouts, type systems, colors, voices, and navigation patterns.
...
- CELA-aligned fictitious company/domain/contact data.

## CELA alignment notes

- Company names and domains use the approved fictitious company/domain list.
- Portuguese personal names use the approved fictitious Portuguese-name list.
- Contact emails use a first-name-only username on an approved fictitious domain, for example `raquel@contososuites.com`.
- International phone numbers are sequential demonstration numbers: `+351 210 000 001` through `+351 210 000 030`.
...
- All commercial properties, people, schedules, prices, comments, policies, and services are fictional demonstration content.
...
- `styles.css` — shared portal/watch styles
...
- `server.mjs` — tiny local static server for development/demo use
